...
serve(async (req: Request) => {
    ...
    try {
        ...
        chapters.forEach((ch: any) => {
            ...
            chaptersHtml += '<div class="chapter-content">' + (ch.content || '') + '</div>';
        ...
        const htmlContent = [
            ...
            "    h1.book-title { font-size: 32pt; text-align: center; margin-top: 5cm; margin-bottom: 2cm; page-break-after: always; }",
